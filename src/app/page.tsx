...
export default function Page() {
  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen bg-gradient-to-br from-white to-violet-950 text-black font-sans">
      <Card className="w-[400px] p-6 rounded-md shadow-lg bg-white text-black text-center">
        <CardHeader>
        ...
        <CardContent className="space-y-6">
          ...
          <p className="text-base sm:text-lg leading-relaxed opacity-90">
            Streamline your hostel management with easy bookings, seamless
            check-ins, automated renewals, and real-time insights. Stay
            organized and focus on what matters most—providing an exceptional
            guest experience.
          </p>
          <Button
